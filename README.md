...
[![CircleCI](https://img.shields.io/circleci/project/github/nschloe/fjson/master.svg?style=flat-square)](https://circleci.com/gh/nschloe/fjson/tree/master)
[![travis](https://img.shields.io/travis/nschloe/fjson.svg?style=flat-square)](https://travis-ci.org/nschloe/fjson)
...
[![awesome](https://img.shields.io/badge/awesome-yes-8209ba.svg?style=flat-square)](https://github.com/nschloe/fjson)
...
First run
```
find . -type f -print0 -name "*.py" -o -name Makefile -o -name "*.yml" | xargs -0 sed -i 's/fjson/your-project-name/g'
```
and rename the folder `fjson` to customize the name.
...
To run the fjson unit tests, check out this repository and type
```
pytest
```
